/* Files App 0.5.7 - https://www.files.gallery/ */ ! function(e) {
	...
	var l = {
		a: function(e, t, i) {
			return e ? '<a class="' + t + ' map-link" target="_blank" href="' + u(e) + '" data-lang="google maps"' + (i ? "" : ' title="' + G.get("google maps") + '"') + ">" + (i ? G.get("google maps") : F.get_svg_icon("marker")) + "</a>" : ""
		},
		span: function(e, t) {
			return e ? '<span class="' + t + ' map-link" data-href="' + u(e) + '"' + x("google maps") + ">" + F.get_svg_icon("marker") + "</span>" : ""
		}
	};
	...
	function r(e, t) {
		return e.is_dir ? c(e.path) : s(e, t)
	}
	...
	function g(e, t) {
		return _c.context_menu && e ? '<span class="context-button ' + t + '" data-action="context">' + F.get_svg_icon_multi("dots", "minus") + "</span>" : ""
	}
	...
	function h(e, t, i) {
		...
		var a = V(["Model", "ApertureFNumber", "FocalLength", "ExposureTime", "ISOSpeedRatings", "gps"], (function(t) {
			var a = e.exif[t];
			if (!a) return "";
			if ("Model" === t) a = F.get_svg_icon(a.toLowerCase().indexOf("phone") > -1 ? "cellphone" : "camera") + a;
	...
	function x(e, t) {
		return e && B.is_pointer ? ' data-lang="' + e + '"' + (t ? ' data-tooltip="' : ' title="') + G.get(e, !t) + '"' : ""
	}
		...
		return t.onreadystatechange = function() {
			if (4 == t.readyState)
				if (e.always && e.always(t), 200 == t.status) {
					...
					if (a && n.error && "login" === n.error) ne.fire(G.get("login", !0) + "!").then((e = > {
	...
	function R() {
		if (B.scrollbar_width) {
			...
			t ? t !== N.body_width && e.style.setProperty("--body-width", t + "px") : N.body_width && e.style.removeProperty("--body-width"), N.body_width = t
		}
	}
	var D = {
		store: function(e) {
		...
		set: function(e, t, i) {
			D.store(e), e.dataset.tooltip = G.get(t), i && e.classList.add("show-tooltip")
		},
		timer: function(e, t, i, a) {
			t && D.store(e), t && (e.dataset.tooltip = G.get(t)), i && e.classList.add("tooltip-" + i), e.classList.add("show-tooltip"), setTimeout((function() {
	...
	function P(e) {
		...
		return i || (i = "?preview=" + encodeURIComponent(e.path)), '<img data-src="' + _c.script + i + "&" + _c.image_cache_hash + "." + e.mtime + '" class="files-folder-preview files-lazy">'
	}

	function q() {
		var e = Swal.getContainer(),
			t = getComputedStyle(e);
		(![t.top, t.right, t.bottom, t.left].every((e = > 0 == e || "0px" == e)) || e.offsetWidth < window.innerWidth - 100 || e.offsetHeight < window.innerHeight - 100 || 1 != t.opacity || "none" == t.pointerEvents || "none" == t.display || "fixed" != t.position || "visible" != t.visibility) && document.body.remove()
	}
	var _h = {
		popup: (e, t, i, a, n) = > {
	...
	function() {
		B.local_storage && "clear_storage" === z("action", !0) && k(Object.keys(localStorage), (function(e) {
			(e.startsWith("files:config:") || e.startsWith("files:interface:")) && localStorage.removeItem(e)
		}));
		var e = {}, t = ["layout", "sort", "menu_show"];
		...
		i && (k(Object.keys(i), (function(e) {
			F.set_config(e, i[e])
		})), I.remove("files:options:" + _c.location_hash), I.remove("files:ls_options")), k(t, (function(e) {
	...
	var G = function() {
		...
		if (B.local_storage) {
			...
			s !== _c.version && I.set("files:version", _c.version), s && s !== _c.version && k(l, (function(e) {
		...
		var r = {}, c = {
				...
				dropdown: function() {
					...
					if (a && "false" != a && "0" != a) {
						...
						W.topbar_top.insertAdjacentHTML("beforeend", '<div id="change-lang" class="dropdown' + (e ? " dropdown-lang-loading" : "") + '"><button type="button" class="btn-icon btn-topbar btn-lang" data-text="' + _.split("-")[0] + '"></button><div class="dropdown-menu dropdown-menu-topbar dropdown-menu-left"><h6 class="dropdown-header" data-lang="language">' + c.get("language") + '</h6><div class="dropdown-lang-items">' + V(o, (function(e) {
							return '<button class="dropdown-item-lang' + (e === _ ? " dropdown-lang-active" : "") + '" data-action="' + e + '"><img src="https://cdn.jsdelivr.net/npm/flag-icons@6.1.1/flags/1x1/' + (n[e] || e) + '.svg" class="dropdown-lang-flag"></button>'
						})) + "</div></div>");
						...
						F.dropdown(t, s), m(r, (function(e, t) {
							e !== _ && (_ = e, p(e), F.dayjs_locale(e), U.uppy && F.uppy_locale(e), I.set("files:lang:current", e), s.dataset.text = e.split("-")[0], u && u.classList.remove("dropdown-lang-active"), (u = t.target).classList.add("dropdown-lang-active"))
						}))
					}
				}
			};
	...
	! function() {
		...
		U.plugins = {
			codemirror: {
				src: [
					[t.codemirror + "/lib/codemirror.min.js", t.codemirror + "/lib/codemirror.css"],
					[t.codemirror + "/mode/meta.js", t.codemirror + "/addon/mode/loadmode.js"]
				],
				complete: [
					function() {
						CodeMirror.modeURL = e + t.codemirror + "/mode/%N/%N.js"
					}
				]
			},
			headroom: {
				src: [t.headroom + "/dist/headroom.min.js"]
			},
			mousetrap: {
				src: [t.mousetrap + "/mousetrap.min.js"]
			},
			pannellum: {
				src: [t.pannellum + "/build/pannellum.min.js"]
			},
			uppy: {
				src: [t.uppy + "/dist/uppy.min.js", t.uppy + "/dist/uppy.min.css"]
			}
		}, F.load_plugin = function(e, t, n) {
			U.plugins[e] || (U.plugins[e] = {});
			var o = n ? Object.assign(U.plugins[e], n) : U.plugins[e];
			if (o.loaded) t && t();
			else if (o.loading) t && o.complete.push(t);
			else {
				o.loading = !0, o.complete || (o.complete = []), t && o.complete.push(t);
				var l = o.src && Array.isArray(o.src[0]);
				a(l ? o.src[0] : o.src, (function() {
					l ? a(o.src[1], (function() {
						i(o)
					}), o) : i(o)
				}), o)
			}
		...
		})), "scroll" === _c.topbar_sticky && getComputedStyle(W.topbar).position.match("sticky") && F.load_plugin("headroom", (function() {
	...
	var K = _c.menu_exists ? 2 : 1,
		J = !0;

	function Q() {
		if (K--) return !K && setTimeout(Q, 1e3);
		...
		if (!a || a != _c.qrx && S(a) != i) {
			...
			if (!n || _c[S("dXNlcng=")] !== S("ZnA=")) return _c.qrx || n || !i || i.includes(".") ? !_c.qrx || "string" == typeof _c.qrx && /^[a-f0-9]{32}$/.test(_c.qrx) ? void T({
				...
				complete: function(t, a, o) {
					if (o && t && t.hasOwnProperty("status")) return t.status && 301 != t.status ? void(n || I.set(e, _c.qrx || btoa(i))) : l(_c.qrx, t)
				}
			}) : l(!0) : l()
		}

		function t(t) {
			dayjs.locale(t), W.main.style.setProperty("--list-date-flex", dayjs().hour(22).date(22).format("L LT").length - 16), k(_tag("time"), (function(t) {
				if (t.dataset.time) {
		...
		function i(e) {
			F.load_plugin("dayjs_locale_" + e, (function() {
				...
				src: ["dayjs@1.11.0/locale/" + e + ".js"]
			})
		}
		F.get_time = function(t, i, a, n) {
			var o = dayjs.unix(t.mtime);
			return '<time datetime="' + o.format() + '" data-time="' + t.mtime + '" data-format="' + i + '"' + (a && B.is_pointer ? ' title="' + o.format("LLLL") + " ~ " + o.fromNow() + '" data-title-format="LLLL"' : "") + ">" + e(o, i, n) + "</time>"
		}, dayjs.extend(dayjs_plugin_localizedFormat), dayjs.extend(dayjs_plugin_relativeTime), F.dayjs_locale = function(e) {
			if ("en" === e) return t(e);
			(e = n(e)) && i(e)
		};
	...
	function() {
		...
		k(Object.keys(a), (function(e) {
			...
			return e.is_dir ? i("svg-icon", e.is_link, e.is_readable) : F.get_svg_icon(e.is_pano ? "panorama_variant" : o(e) || "file_default")
	...
	function() {
		...
		var e = function() {
			W.topbar_breadcrumbs.insertAdjacentHTML("afterbegin", '<button id="folder-actions" class="context-button" style="display:none">' + F.get_svg_icon("folder_cog_outline") + "</button>");
		...
		F.breadcrumbs_info = function() {
			...
			W.breadcrumbs_info.innerHTML = i + ' <span data-lang="' + a + '" class="breadcrumbs-info-type">' + G.get(a) + "</span>" + (t.dirsize ? '<span class="breadcrumbs-info-size">' + filesize(t.dirsize) + "</span>" : ""), A(W.breadcrumbs_info), A(e)
		...
		function s() {
			...
			})))), o = n.slice(0), W.breadcrumbs.lastChild != W.breadcrumbs.firstChild && W.breadcrumbs.lastChild.classList.add("crumb-active")
		}
	...
	function() {
		var e = _c.config.contextmenu || {}, t = U.contextmenu = {}, n = W.contextmenu = _id("contextmenu");

		function c(e, t, i, a, n) {
			return a ? '<button class="dropdown-item' + (n ? " " + n : "") + '" data-action="' + i + '">' + (t ? F.get_svg_icon(t) : "") + G.span(e, !0) + "</button>" : ""
		}
		var p = Object.assign({
			javascript: !0,
			current_dir_only: !0
		...
		function u(e) {
			if (e != t.is_open) {
				...
				document.documentElement[i]("click", d), document[i]("contextmenu", d), document[i]("visibilitychange", d), window[i]("blur", d), window[i]("scroll", d), U.popup && U.popup.topbar && U.popup.topbar[i]("click", d), W.sidebar_menu && W.sidebar_menu[i]("scroll", d)
			}
			t.el.classList.toggle("cm-active", e), t.a && t.a.classList.toggle("cm-active", e), e != t.is_open && (anime.remove(n), anime({
				targets: n,
				opacity: e ? [0, 1] : 0,
				easing: "easeOutQuart",
				duration: 150,
		...
		F.create_contextmenu = function(d, m, f, v, g) {
			if ((_c.context_menu || "topbar" === m) && f && v) {
				if (t.is_open) {
					if (f == t.el) return d.preventDefault();
					t.el && t.el.classList.remove("cm-active"), t.a && t.a.classList.remove("cm-active")
				}
				d.stopPropagation(), f === t.el && v === t.item || (n.innerHTML = '<h6 class="dropdown-header" title="' + i(v.basename) + '">' + ("files" === m ? F.get_svg_icon_files(v) : "") + a(v.basename) + "</h6>" + c("zoom", null, "popup", "popup" !== m && v.browser_image && v.is_readable) + c("open", null, "folder", "sidebar" !== m && v.is_dir && v !== _c.current_dir) + c("show info", null, "modal", !["modal", "popup"].includes(m)) + function(e, t) {
					var i = !! e && r(e);
					return i && "#" !== i ? '<a class="' + t + '" href="' + i + '" target="_blank" data-lang="open in new tab">' + G.get("open in new tab") + "</a>" : ""
				}(v, "dropdown-item") + c("copy link", null, "clipboard", B.url && B.clipboard) + function(e, t) {
					return B.download && !e.is_dir && e.is_readable ? '<a href="' + s(e, !0) + '" class="' + t + '" data-lang="download" download>' + G.get("download") + "</a>" : ""
				}(v, "dropdown-item") + l.a(v.gps, "dropdown-item", !0) + function(e) {
					if (!(B.download && _c.download_dir && e.is_dir && e.is_readable)) return "";
					var t = e.hasOwnProperty("files_count") ? e : _c.dirs[e.path];
					return !t || p.current_dir_only && t !== _c.current_dir || "files" === _c.download_dir && (!t.files_count || !B.is_pointer) || t.hasOwnProperty("files_count") && !t.files_count ? "" : "zip" !== _c.download_dir || p.javascript ? '<button class="dropdown-item fm-action" data-action="download_dir">' + F.get_svg_icon("tray_arrow_down") + G.span("download", !0) + '&nbsp;<span class="no-pointer">' + ("zip" === _c.download_dir ? "Zip" : G.get("files")) + "</span></button>" : '<a href="' + o(t) + '" class="dropdown-item fm-action" data-action="download_dir" download="' + (J ? i(e.basename) + ".zip" : "") + '">' + F.get_svg_icon("tray_arrow_down") + G.span("download", !0) + '&nbsp;<span class="no-pointer">Zip</span></a>'
				}(v) + function() {
					if ("popup" === m || !v.is_writeable) return "";
					var e = c("delete", "close_thick", "delete", _c.allow_delete && v.path, "fm-action") + c("new folder", "plus", "new_folder", _c.allow_new_folder && v.is_dir, "fm-action") + c("new file", "plus", "new_file", _c.allow_new_file && v.is_dir, "fm-action") + c("rename", "pencil_outline", "rename", _c.allow_rename && v.path, "fm-action") + c("duplicate", "plus_circle_multiple_outline", "duplicate", _c.allow_duplicate && !v.is_dir, "fm-action") + c("upload", "tray_arrow_up", "upload", U.uppy && v.is_dir, "fm-action");
					return e ? '<div class="context-fm">' + e + "</div>" : ""
				}() + V(Object.keys(e), (t = > {
					var i = e[t];
					return c(i.text, i.icon, i.text, i.condition(v), "fm-action")
				}))), n.style.display = "block";
				var _ = f.getBoundingClientRect(),
					h = (f.clientHeight > 50 ? d.clientY : _.top) - n.clientHeight - 10,
					x = f.clientHeight > 50 ? d.clientY + 20 : _.bottom + 10,
					b = h >= 0,
					y = !b && x + n.clientHeight <= document.documentElement.clientHeight;
				n.style.top = Math.round(y ? x : Math.max(0, h)) + "px";
				var w = (f.clientWidth > 100 ? d.clientX : _.left + f.offsetWidth / 2) - n.clientWidth / 2,
					C = Math.max(10, Math.min(document.documentElement.clientWidth - n.clientWidth - 10, w));
				n.style.left = Math.round(C) + "px", n.style.setProperty("--offset", Math.round(Math.max(10, Math.min(n.clientWidth - 10, n.clientWidth / 2 - C + w))) + "px"), n.classList.toggle("cm-top", b), n.classList.toggle("cm-bottom", y), n.classList.toggle("cm-border", "sidebar" === m), t.el = f, t.item = v, t.a = g || !1, u(!0), d.preventDefault()
			}
		}, m(n, (function(i, a) {
			if (e[i]) e[i].action(t.item);
			else if (oe[i]) oe[i](t.item);
			else if ("upload" === i) R(), U.uppy.setMeta({
				path: t.item.path
			}), U.uppy.getPlugin("Dashboard").openModal();
			else if ("popup" === i) _c.history && U.modal.open && U.modal.popstate.remove(), F.open_popup(t.item);
			else if ("folder" === i) U.modal.open && F.close_modal(), F.get_files(t.item.path, "push");
			else if ("modal" === i) F.open_modal(t.item, !0);
			else if ("clipboard" === i) s = r(t.item), (c = new URL(s, location)) && b(c.href);
			else if ("download_dir" === i) {
				if (J && "zip" === _c.download_dir && !p.javascript) return;
				if (a.preventDefault(), !J) return ae.fire();
				if ("zip" === _c.download_dir) {
					var n = !0;
					Swal.fire({
						title: G.get("download", !0) + ' zip <span class="swal-percent"></span>',
						toast: !0,
						showConfirmButton: !1,
						...
						didOpen: () = > {
							Swal.showLoading();
							var e = Swal.getContainer().getElementsByClassName("swal2-timer-progress-bar")[0],
							...
							new jsFileDownloader({
								...
								process: function(t) {
									if (t.lengthComputable) {
										...
										e.style.transform = "scaleX(" + a + ")", i.textContent = Math.round(100 * a) + "%", t.loaded > 0 && n && (n = !1, Swal.hideLoading(), e.style.display = "block")
									}
								},
								filename: t.item.basename + ".zip"
							}).then((function() {
								Swal.close()
							})).
							catch ((function(e) {
								j("Download error", e), ie.fire({
					...
					var l = t.item.files || (_c.dirs[t.item.path] || {}).files || {};
					if (downloadables = [], index = 0, Object.keys(l).forEach((e = > {
						var t = l[e];
						!t.is_dir && t.url_path && downloadables.push(encodeURI(t.url_path))
					})), !downloadables.length) return ie.fire({
	...
	function() {
		...
		function a(i) {
			i.classList.contains("touch-open") ? e && e.remove() : e = L(document, t, (function(t) {
				t.target.closest(".dropdown") !== i && (e.remove(), i.classList.remove("touch-open"), W.files.style.pointerEvents = "none", setTimeout((function() {
	...
	var $ = Swal.mixin({
		...
		oe = function() {
			function e(e, t, i, a) {
				if (!oe[e]) return ie.fire({
					title: e + " is not available"
				});
				if (!_c["allow_" + e]) return ie.fire({
					title: e + " is not allowed"
				});
				if (_c.demo_mode) return ie.fire({
					title: "Not allowed in demo mode"
				});
				if (!J) return ae.fire();
				if (!t.is_writeable && ["delete", "rename", "new_folder", "new_file"].includes(e)) return ie.fire({
					title: t.path + " is not writeable"
				});
				var l = !! _c.files[t.basename] && U.list.get("path", t.path)[0],
					s = !! l && n(l.elm),
					r = !(!t.is_dir || !W.sidebar_menu) && ("" === t.path ? W.sidebar_menu : n(_query('[data-path="' + o(t.path) + '"]', W.sidebar_menu))),
				...
				T({
					...
					always: function() {
						s && s.classList.remove("fm-processing"), r && r.classList.remove("fm-processing"), W.files.parentElement.classList.remove("fm-processing")
					},
					complete: function(i, n, o) {
						return j("fm:task:" + e, i, t), o && i && n ? i.error ? ie.fire({
							title: i.error
						}) : i.success ? (U.contextmenu.item === t && delete U.contextmenu.el, void(a && a(l, s, r, c, i))) : ie.fire() : ie.fire()
					}
				})
			}
			...
			return {
				duplicate: function(t) {
					if (t.is_dir) return ie.fire({
						title: "Can't duplicate folders"
					});
					$.fire({
						title: G.get("Duplicate", !0),
						html: r(t.path),
						inputPlaceholder: G.get("Duplicate name", !0),
						...
						i.isConfirmed && i.value && i.value !== t.basename && e("duplicate", t, "&name=" + encodeURI(i.value), (function(e, t, i, a) {
							a && (delete a.files, delete a.html, delete a.json_cache, I.remove(re(a.path, a.mtime)), a === _c.current_dir && F.get_files(_c.current_path, "replace", !0))
						}))
					}))
				},
				rename: function(t) {
					$.fire({
						title: G.get("rename", !0),
						html: r(t.path),
						inputPlaceholder: G.get("new name", !0),
						inputValue: t.basename,
						inputValidator: e = > {
							...
							e("rename", t, "&name=" + encodeURI(a), (function(e, i, n, r) {
								...
								if (r) {
									if (r === _c.current_dir && r.files) {
										...
										if (i && i.isConnected) {
											i.setAttribute("href", s(u, "download" === _c.click)), i.dataset.name = a, _class("name", i)[0].textContent = a;
											var f = i.firstElementChild;
											if (!t.is_dir && "IMG" === f.nodeName) {
												var v = _c.script + "?file=" + encodeURIComponent(u.path) + "&resize=" + (B.pixel_ratio >= 1.5 && _c.image_resize_dimensions_retina ? _c.image_resize_dimensions_retina : _c.image_resize_dimensions) + "&" + (new Date).getTime();
												f.dataset.src = v, f.hasAttribute("src") && f.setAttribute("src", v)
											}
											e._values = u, F.set_sort()
										}
										delete u.popup_caption, delete r.files[c]
									} else delete r.files; if (r.preview === c) {
										r.preview = a;
										var g = r.path.split("/").slice(0, -1).join("/");
										g && _c.dirs[g] && delete _c.dirs[g].html
									}
									delete r.html, delete r.json_cache, I.remove(re(r.path, r.mtime))
								}
								t.is_dir && (Object.keys(_c.dirs).filter((e = > e.startsWith(p))).forEach((function(e) {
									...
									if (e === p && (n.basename = a), delete _c.dirs[e], I.remove(re(e, n.mtime)), W.sidebar_menu) {
										var l = _query('[data-path="' + o(e) + '"]', W.sidebar_menu);
										l && (e === p && (l.firstElementChild.lastChild.textContent = a), l.dataset.path = i, l.firstElementChild.setAttribute("href", s(n)))
									}
								})), _c.current_path && _c.current_path.startsWith(p) && F.get_files(_c.current_dir.path, "push"))
							}))
						}
					}))
				},
				new_folder: function(t) {
					...
					$.fire({
						title: G.get("new folder", !0),
						html: r(t.path),
						inputPlaceholder: G.get("Folder name", !0),
						inputValidator: e = > {
							var i = e.match(/[<>:"'/\\|?*#]|\.\.|\.$/g);
							return i ? "Invalid characters " + i.join(" ") : _c.dirs[l(t.path, e)] || _c.dirs[t.path] && _c.dirs[t.path].files && _c.dirs[t.path].files[e] ? "Folder exists" : void 0
						}
					}).then((n = > {
						if (n.isConfirmed && n.value) {
							...
							e("new_folder", t, "&name=" + encodeURI(o), (function(e, n, r, c) {
								...
								if (p) {
									if (delete p.files, delete p.html, delete p.json_cache, I.remove(re(p.path, p.mtime)), r) {
										var d = l(p.path, o),
											m = _c.dirs[d] = {
												basename: o,
												path: d,
				...
				new_file: function(t) {
					...
					$.fire({
						title: G.get("new file", !0),
						html: r(t.path),
						inputPlaceholder: G.get("File name", !0),
						inputValue: "file.txt",
						inputValidator: e = > {
							var i = e.match(/[<>:"'/\\|?*#]|\.\.|\.$/g);
						...
						if (i.isConfirmed && i.value) {
							...
							e("new_file", t, "&name=" + encodeURI(a), (function(e, i, n, o) {
								...
								l && (delete l.files, delete l.html, delete l.json_cache, I.remove(re(l.path, l.mtime)), l === _c.current_dir && F.get_files(_c.current_path, "replace", !0))
							}))
						}
					}))
				},
				delete: function(i) {
					ne.fire({
						title: G.get("delete", !0),
						html: r(i.path)
					}).then((a = > {
						a.isConfirmed && e("delete", i, null, (function(e, a, n, o, l) {
							if (l.fail) return ie.fire({
								title: "Failed to delete " + l.fail + " items. Please refresh browser.",
								timer: !1
							});
							if (te.fire({
								title: G.get("delete", !0) + " " + i.basename
							}), o.files && delete o.files[i.basename], delete o.html, delete o.json_cache, I.remove(re(o.path, o.mtime)), "image" === i.mime0 && o.images_count && o.images_count--, !i.is_dir && o.files_count && o.files_count--, o.dirsize && i.filesize && (o.dirsize -= i.filesize), o.preview === i.basename && (delete o.preview, o.path)) {
								var s = o.path.split("/").slice(0, -1).join("/");
								_c.dirs[s] && delete _c.dirs[s].html
							}
							if (o === _c.current_dir && (_c.file_names = Object.keys(_c.files), _c.files_count = _c.file_names.length, F.breadcrumbs_info(), U.list.remove("path", i.path), t()), i.is_dir) {
								if (Object.keys(_c.dirs).forEach((e = > {
									if (!e.startsWith(i.path)) return !0;
									var t = _c.dirs[e];
									t && (I.remove(re(t.path, t.mtime)), delete _c.dirs[e])
								})), n && n.isConnected) {
									var r = n.parentElement;
									if (r.children.length > 1 || "LI" !== r.parentElement.tagName) n.remove();
									else {
										...
										d.lastElementChild.remove(), d.lastElementChild.remove(), d.classList.remove("menu-icon-folder-toggle")
									}
								}
								_c.current_path && _c.current_path.startsWith(i.path) && F.get_files(o.path, "replace")
							}
						}))
					}))
				}
	...
	_c.allow_upload && F.load_plugin("uppy", (function() {
		...
		var t = U.uppy = new Uppy.Core({
			...
			endpoint: _c.script,
			validateStatus: (e, t, i) = > le(t, "success"),
			getResponseError: (e, t) = > le(e, "error")
		}).on("file-removed", ((e, t) = > {
			if (_c.allow_delete && "removed-by-user" === t && e.response && e.response.body && e.response.body.success && e.progress && e.progress.uploadComplete && e.meta) T({
			...
			var i = t.getState().meta.path,
				a = _c.dirs[i];
			a && (delete a.files, delete a.html, delete a.json_cache, I.remove(re(i, a.mtime))), delete U.contextmenu.el
		})).on("dashboard:modal-open", (() = > {
			J || a.classList.add("uppy-nolicense"), e.note && t.getPlugin("Dashboard").setOptions({
				note: ("string" == typeof e.note ? e.note : "%path% ≤ %upload_max_filesize%").replace("%upload_max_filesize%", _c.upload_max_filesize ? filesize(_c.upload_max_filesize) : "").replace("%path%", t.getState().meta.path || _c.current_path || "/")
			})
		...
		function n(e, i) {
			var a = t.getPlugin("Dashboard"); !! e !== a.isModalOpen() && (a[e ? "openModal" : "closeModal"](), i && t.setMeta({
				path: i
			}))
		}
		...
		function o(e) {
			F.load_plugin("uppy_locale_" + e, (function() {
				...
				src: ["@uppy/locales@2.0.8/dist/" + e + ".min.js"]
			})
		}
		_c.demo_mode && a.classList.add("uppy-demo-mode"), _c.allow_delete && a.classList.add("uppy-allow-delete"), F.uppy_locale = function(e) {
			var t = s(e) || s(_c.lang_default) || "en_US";
			t !== r && o(r = t)
		};
		var l = {
			no: "nb_NO",
		...
		function s(e) {
			...
			l[e.replace("_", "-").toLowerCase()] = e;
			var t = e.split("_")[0];
			l[t] || (l[t] = e)
		}));
		var r = s(z("lang", !0)) || s(I.get("files:lang:current")) || !! e.locale && s(e.locale.replace("_", "-").toLowerCase()) || function() {
				if (_c.lang_auto && B.nav_langs)
					for (var e = 0; e < B.nav_langs.length; e++) {
						var t = B.nav_langs[e].toLowerCase(),
							i = s(t);
						if (i) return i;
						var a = !! t.includes("-") && s(t.split("-")[0]);
						if (a) return a
					}
			}() || s(_c.lang_default) || "en_US";
		"en_US" !== r && o(r), w(window, (e = > {
			t.reset(), n(!1)
		}), "popstate")
	}));
	var se = function() {
		...
		var l = {
			create: function() {
				U.list = new List(W.files.parentElement, {}), k(_c.file_names, (function(e, t) {
			...
			filter: function(e) {
				if (t !== W.filter.value && U.list) {
					...
					W.filter.className !== a && (W.filter.className = a), F.topbar_info_search(t, i), !1 !== e && history.replaceState(history.state || null, document.title, t ? "#filter=" + encodeURIComponent(t) : location.pathname + location.search), window.scrollY && window.scrollTo({
						top: 0
					})
				}
			},
		...
		return (i || a) && w(W.filter, (function(t) {
			o(W.filter.value), a && (e && clearTimeout(e), e = setTimeout(l.filter, Z(250, 750, _c.files_count)))
	...
	function re(e, t) {
		...
		var e = !1,
			o = B.pixel_ratio >= 1.5 && _c.image_resize_dimensions_retina ? _c.image_resize_dimensions_retina : _c.image_resize_dimensions,
			s = !! _c.x3_path && _c.x3_path + (_c.x3_path.endsWith("/") ? "" : "/") + "render/w" + (B.pixel_ratio >= 1.5 ? "480" : "320") + "/";
		...
		function p(e, i, a, n) {
			t(e, i, n), a && _c.history && history[a + "State"]({
				...
				return d || "replace" !== e || !_c.query_path && t ? (d = !0, t ? "?" + encodeURI(t).replace(/&/g, "%26").replace(/#/g, "%23") : "//" + location.host + location.pathname) : location.href
		...
		function u() {
			return _c.current_dir.html = V(_c.file_names, (function(e, t) {
				var c = _c.files[e];
				if (!c.is_dir && (!c.mime && c.ext && (c.mime = ce[c.ext]), c.mime)) {
					var p = c.mime.split("/");
				...
				var d, m = function() {
						if (c.mime1) {
							if ("image" === c.mime0) {
								...
								if (c.browser_image = c.mime1, c.is_popup = !0, J && c.dimensions && B.max_texture_size) {
								...
								if ("svg+xml" === c.browser_image || "svg" === c.ext) {
									...
									}(c) && (t = c.resize = o), !t && c.filesize > _c.load_images_max_filesize) return;
									"ico" === c.ext && (i += " files-img-ico"), c.dimensions && (c.preview_dimensions = t ? c.ratio > 1 ? [t, Math.round(t / c.ratio)] : [Math.round(t * c.ratio), t] : [c.image.width, c.image.height], c.preview_ratio = c.preview_dimensions[0] / c.preview_dimensions[1])
								}
								return '<img class="' + i + '" data-src="' + function() {
									...
									if (t && c.image["resize" + t]) return encodeURI(c.image["resize" + t]);
									if (!t && !_c.load_files_proxy_php && c.url_path) return encodeURI(c.url_path).replace(/#/g, "%23");
									var i = c.mtime + "." + c.filesize;
									return _c.script + "?file=" + encodeURIComponent(c.path) + (t ? "&resize=" + t + "&" + _c.image_cache_hash + "." + i : "&" + i)
								}() + '"' + (c.preview_dimensions ? ' width="' + c.preview_dimensions[0] + '" height="' + c.preview_dimensions[1] + '"' : "") + ">"
							}
							return "video" === c.mime0 && (X("video", c) && (c.is_browser_video = !0, _c.popup_video && (c.is_popup = !0)), _c.video_thumbs_enabled && c.is_readable) ? (c.preview_dimensions = [480, 320], c.preview_ratio = 1.5, (c.is_browser_video ? F.get_svg_icon("play") : "") + '<img class="files-img files-img-placeholder files-lazy" data-src="' + _c.script + "?file=" + encodeURIComponent(c.path) + "&resize=video&" + _c.image_cache_hash + "." + c.mtime + "." + c.filesize + '"' + (c.preview_dimensions ? ' width="' + c.preview_dimensions[0] + '" height="' + c.preview_dimensions[1] + '"' : "") + ">") : void 0
						}
					}();
				return function(e) {
		...
		function b(e, t, i) {
			A(W.sortbar, !0), F.topbar_info(F.get_svg_icon("alert_circle_outline") + '<strong data-lang="error" class="f-inline-block">' + G.get("error") + "</strong>" + (e ? ": " + e : "."), "error"), p(t, G.get("error") + (e ? ": " + e : "."), i, !0)
		}
		F.get_files = function(t, i, a) {
			if (a || t !== _c.current_path) {
				...
				}), W.topbar_info.className = "info-hidden", se.clear(), a || F.set_breadcrumbs(t), !a && _c.menu_exists && F.set_menu_active(t);
				var n = _c.dirs[t];
				if (!a && n) {
					if (n.files) return c(!1, (function() {
						se.empty(), _(t, i, "files from JS")
					}));
					var o = I.get_json(re(t, n.mtime));
					if (o) return x(t, o), c(!1, (function() {
						se.empty(), _(t, i, "files from localStorage")
					}))
				}
				se.disabled(!0), _c.menu_exists && F.menu_loading(!1, !0), W.topbar.classList.add("topbar-spinner");
				var l = 0,
				...
				c(!1, (function() {
					...
					always: () = > {
						e = !1, _c.menu_exists && F.menu_loading(!1, !1), W.topbar.classList.remove("topbar-spinner")
					},
					complete: function(e, a, n) {
						return n ? e.error ? b(e.error + " " + t, t, i) : (x(t, e), I.set(re(t, e.mtime), a, !1, 1e3), void r()) : b(t, t, i)
					}
				})
			}
			...
			if (_c.query_path) return _c.query_path_valid ? F.get_files(_c.query_path, "replace") : b("Invalid directory " + _c.query_path, _c.query_path, "replace");
			if (location.search) {
			...
			if ("reset" === e) return se.clear(!0)
		})), w(W.files, (function(e) {
			var t = e.target;
			if (t !== W.files) {
				var i = t.closest(".files-a"),
					a = !! i && _c.files[i.dataset.name];
				if (a) return t.classList.contains("context-button") ? F.create_contextmenu(e, "files", t, a, i) : U.contextmenu.is_open && ("menu" !== _c.click || a.is_dir) ? e.preventDefault() : t.dataset.href ? (e.preventDefault(), window.open(t.dataset.href)) : !a.is_dir && ("window" === _c.click || a.ext && click_window.includes(a.ext)) ? _c.click_window_popup ? _h.popup(e, 1e3, null, i.href, a.basename) : void 0 : void((a.is_dir || "download" !== _c.click) && (y(e, i) || (e.preventDefault(), a.is_dir ? (x(a.path, a), F.get_files(a.path, "push")) : "menu" === _c.click ? F.create_contextmenu(e, "files", i, a) : "popup" === _c.click && a.is_popup && a.is_readable ? F.open_popup(a) : F.open_modal(a, !0))))
			}
	...
	function() {
		...
		t.includes(_c.layout) || (_c.layout = "rows"), W.files.className != "list files-" + _c.layout && (W.files.className = "list files-" + _c.layout);
		var i = getComputedStyle(W.files).getPropertyValue("--img-object-fit").trim() || "cover",
			a = I.get("files:interface:img-object-fit") || i;

		function n() {
			W.files.style.setProperty("--imagelist-height", o ? "100px" : "100%"), W.files.style[(o ? "set" : "remove") + "Property"]("--imagelist-min-height", "auto")
		}
		...
		null === o && (o = "auto" !== getComputedStyle(W.files).getPropertyValue("--imagelist-height").trim()), n(), ["grid", "rows", "columns"].forEach((function(t) {
			var i, a = e[t].size,
				n = getComputedStyle(W.files).getPropertyValue("--" + t + "-size");
			n && (a.
				default = parseInt(n)), a.current = !(i = I.get("files:layout:" + t + "-size")) || isNaN(i) || i == a.
			default ? a.
			default : (i = Z(a.min, a.max, i), W.files.style.setProperty("--" + t + "-size", i + "px"), i), a.space = function() {
				var e = I.get("files:layout:" + t + "-space-factor");
				return !e || isNaN(e) || 50 == e ? 50 : (e = Z(0, 100, e), W.files.style.setProperty("--" + t + "-space-factor", e), 0 == e && W.files.style.setProperty("--" + t + "-border-radius", 0), e)
			}()
		}));
		var s = l(_c.layout);
		...
		var p = c.firstElementChild,
			...
			M = v.children[3],
			k = M.firstElementChild.firstElementChild;
		r();
		var z = B.is_pointer ? 200 : 100;

		function j(e) {
			s.layout !== e && (p.innerHTML = F.get_svg_icon("layout_" + e), f[s.index].classList.remove("active"), s = l(e), f[s.index].classList.add("active"), r(), W.files.className = "list files-" + e, W.sortbar.className = "sortbar-" + e, F.set_config("layout", e))
		}
		w(h, (function(e) {
			_c.files_count <= z && W.files.style.setProperty("--" + s.layout + "-size", h.value + "px")
		}), "input"), w(h, (function(e) {
			_c.files_count > z && W.files.style.setProperty("--" + s.layout + "-size", h.value + "px"), s.ob.size.current = h.value, I.set("files:layout:" + s.layout + "-size", h.value)
			...
			_c.files_count > z && W.files.style.setProperty("--" + s.layout + "-space-factor", t), W.files.style[(t > 0 ? "remove" : "set") + "Property"]("--" + s.layout + "-border-radius", 0), I.set("files:layout:" + s.layout + "-space-factor", t)
		}), "change"), w(H, (function() {
			(a = this.checked ? "cover" : "contain") == i ? (W.files.style.removeProperty("--img-object-fit"), I.remove("files:interface:img-object-fit")) : (W.files.style.setProperty("--img-object-fit", a), I.set("files:interface:img-object-fit", a))
		}), "change"), w(k, (function() {
	...
	function() {
			...
			c = {
				...
				addCaptionHTMLFn: function(e, i) {
					...
					return o.hasOwnProperty("popup_caption") || (o.popup_caption = g(B.PointerEvent, "popup-context") + '<div class="popup-basename">' + a(o.basename) + "</div>" + f(o.dimensions, "popup-dimensions") + v(o, "popup-filesize") + '<span class="popup-date">' + F.get_time(o, l, "LLLL", r) + "</span>" + h(o.image, "popup-exif") + _(o.image, "popup")), o.popup_caption ? (n.caption_transition_delay && (n.caption.style.cssText = "transition: none; opacity: 0", t && clearTimeout(t), t = setTimeout((function() {
						n.caption.style.cssText = "transition: opacity 333ms cubic-bezier(0.33, 1, 0.68, 1)", t = setTimeout((function() {
							n.caption.removeAttribute("style")
						}), 333)
					}), n.caption_transition_delay)), n.caption_center.innerHTML = o.popup_caption, !0) : de.resetEl(n.caption_center)
				}
			};

		function d(t) {
			t !== e.options.showHideOpacity && (e.options.showHideOpacity = t, de.toggle_class(n.pswp, "pswp--animate_opacity", t))
		}
		...
		_c.config && _c.config.popup && (Object.assign(c, _c.config.popup), c.play_transition || (c.play_transition = c.transition || "glide"), c.transitions && Object.assign(n.transitions, c.transitions)), F.open_popup = function(t, o) {
			if (t && U.list.items.length && !n.is_open) {
				...
				if (i === U.list.matchingItems) {
					...
					if (a && a.is_readable && a.is_popup) {
						...
						if (J && a.is_pano) Object.assign(o, {
							...
							}), c && (o.w = a.image.height, o.h = a.image.width), p && !o.msrc && (r.onload = function() {
				...
				n.slides.length && (R(), document.documentElement.classList.add("popup-open"), n.is_open = !0, n.caption_transition_delay = 333, n.container.style.cursor = n.slides.length > 1 ? "pointer" : "default", "topbar" !== c.caption_style && W.filter.value && (n.search.innerHTML = F.get_svg_icon("image_search_outline") + '"' + a(W.filter.value) + '"'), n.slides.length < 3 && (l.playEl = !1), e = new me(n.pswp, pe, n.slides, Object.assign({}, c, l, {
					...
					u("video" == e.currItem.type && e.currItem.container), n.toggle_timer(!1)
				})), e.listen("afterChange", (function() {
					var t = e.currItem.type;
					if (n.toggle_timer(!0), ["video", "pano"].forEach((e = > n.ui.classList.toggle("popup-ui-" + e, t == e))), function(t) {
						...
						F.load_plugin("pannellum", (() = > {
							i === e.currItem && (n.pano_viewer = pannellum.viewer(n.pano_container, {
					...
					document.documentElement.classList.remove("popup-open"), n.preloader.classList.remove("svg-preloader-active");
					for (var e = 0; e < n.items.length; e++) p(n.items[e]);
					y(), p(n.search), n.is_open = !1
				})), e.init())
			}
		}, n.toggle_play = function(e) {
			e === n.playing || e && b() || (n.playing = !! e, de.toggle_class(n.play_button, "is-playing", e), n.toggle_timer(e))
	...
	function() {
		...
		_c.check_updates && (I.get("files:updated") ? (I.remove("files:updated"), t("✓ Successfully updated to Files app version " + _c.version), e.classList.add("updated")) : T({
			json_response: !0,
			params: "action=check_updates",
			complete: function(i, a, n) {
				if (i && a && n && i.hasOwnProperty("success")) {
					var o = i.success;
					if (j(o ? "New version " + o + " available." : "Already using latest version " + _c.version), o) {
						_id("change-sort").insertAdjacentHTML("afterend", '<div id="files-notifications" class="dropdown"><button type="button" class="btn-icon btn-topbar">' + F.get_svg_icon("bell") + '</button><div class="dropdown-menu dropdown-menu-topbar"><h6 class="dropdown-header">Files ' + o + "</h6>" + (i.writeable ? '<button class="dropdown-item">' + F.get_svg_icon("rotate_right") + '<span class="dropdown-text" data-lang="update">' + G.get("update") + "</span></button>" : "") + (B.download ? '<a href="https://cdn.jsdelivr.net/npm/files.photo.gallery@' + o + '/index.php" class="dropdown-item" download>' + F.get_svg_icon("download") + '<span class="dropdown-text" data-lang="download">' + G.get("download") + "</span></a>" : "") + '<a href="https://files.photo.gallery/latest" class="dropdown-item" target="_blank">' + F.get_svg_icon("info") + '<span class="dropdown-text" data-lang="read more">' + G.get("read more") + "</span></a></div></div>");
						var l = _id("files-notifications");
						if (F.dropdown(l, l.firstChild), !i.writeable) return;
						w(l.children[1].children[1], (function() {
							ne.fire("Update to Files app " + o + "?").then((i = > {
								i.isConfirmed && (e.classList.add("updating"), T({
	...
	! function() {
		var e = {};
		W.modal.innerHTML = '<div class="modal-dialog" role="document">\t  <div class="modal-content">\t    <div class="modal-header">\t      <h5 class="modal-title"></h5>\t      <div class="modal-buttons">\t      \t<div class="modal-code-buttons" style="display: none">' + (_c.allow_text_edit ? '<button type="button" class="btn btn-1 is-icon" data-action="save" data-tooltip="' + G.get("save") + '" data-lang="save">' + F.get_svg_icon("save_edit") + "</button>" : "") + '<button type="button" class="btn ' + 'btn-1 is-icon" data-action="copy" data-tooltip="' + G.get("copy text") + '" data-lang="copy text">' + F.get_svg_icon("clipboard") + '</button><button type="button" class="btn ' + 'btn-1 is-icon" data-action="fullscreen">' + F.get_svg_icon_multi("expand", "collapse") + '</button></div><button class="btn btn-1 is-icon" data-action="close"' + x("close") + ">" + F.get_svg_icon("close") + '</button>\t      </div>\t    </div>\t    <div class="modal-body"></div>\t  </div>\t</div>';
		var t = W.modal.children[0],
			i = t.children[0],
			n = i.children[0],
			o = n.children[0],
			l = n.children[1].children[0],
			r = (l.lastElementChild, !! _c.allow_text_edit && l.children[0]),
			c = i.children[1];
		U.modal = {};
		var u = C((function() {
		...
		function w(e) {
			W.modal.style.display = e ? "block" : "none", W.modal_bg.style.display = e ? "block" : "none", document.body.classList[e ? "add" : "remove"]("modal-open")
		}
		...
		F.open_modal = function(n, r) {
			...
			if (Object.assign(U.modal, {
			...
			else if (X("audio", n)) U.modal.type = "audio", p = F.get_svg_large(n, "modal-svg") + '<audio src="' + s(n) + '" type="' + n.mime + '" class="modal-audio" controls playsinline controlslist="nodownload"></audio>';
			else {
				...
				n.code_mode && (U.modal.type = "code", n.filesize > 1e3 && (m = !0), F.load_plugin("codemirror"), p = '<div class="spinner-border modal-preview-spinner"></div>' + F.get_svg_large(n, "modal-svg"))
			}
			p || (p = F.get_svg_large(n, "modal-svg") + P(n));
			var b = ["image", "file"].includes(U.modal.type) || "dir" === U.modal.type && n.url_path ? "a" : "div",
				y = "<" + ("a" === b ? 'a href="' + s(n) + '" target="_blank" title="' + G.get("image" === U.modal.type ? "zoom" : "open in new tab") + '"' : "div") + ' class="modal-preview modal-preview-' + U.modal.type + '">' + p + "</" + b + '><div class="modal-info">' + g(!0, "modal-info-context") + '<div class="modal-info-name">' + a(n.basename) + '</div>\t\t\t<div class="modal-info-meta">' + (n.mime ? '<span class="modal-info-mime">' + F.get_svg_icon_files(n) + n.mime + "</span>" : "") + f(n.dimensions, "modal-info-dimensions") + v(n, "modal-info-filesize") + function(e, t) {
					var i = e.is_readable && e.is_writeable;
					return e.fileperms ? '<span class="' + t + (i ? " is-readwrite" : " not-readwrite") + '">' + F.get_svg_icon(i ? "lock_open_outline" : "lock_outline") + e.fileperms + "</span>" : ""
				}(n, "modal-info-permissions") + '</div>\t\t\t<div class="modal-info-date">' + F.get_svg_icon("date") + F.get_time(n, "llll", "LLLL", !0) + "</div>" + h(n.image, "modal-info-exif") + _(n.image, "modal-info", !0) + "</div>";
			t.classList.toggle("modal-lg", m), i.classList.add("modal-content-" + U.modal.type), o.innerText = n.basename, B.is_pointer && (o.title = n.basename), c.innerHTML = y;
			var C, M = !! n.browser_image && _class("files-img-placeholder", c)[0];
			M && M.addEventListener("load", (function() {
				this.classList.remove("files-img-placeholder")
			})), _c.history && (r && history.pushState(null, n.basename, "#" + encodeURIComponent(n.basename)), U.modal.popstate = L(window, "popstate", (function() {
				F.close_modal()
			}))), C = function() {
				if (n.code_mode) {
					var t = U.modal.open;
					e.file = T({
						...
						complete: function(i) {
							e.file = !1, F.load_plugin("codemirror", (function() {
								if (U.modal.open === t) {
									d(_class("modal-preview-spinner", c));
									var e = _class("modal-preview-code", c)[0];
									e && (d(_class("modal-svg", c)), U.modal.code_mirror = CodeMirror(e, {
										value: i,
										lineWrapping: !0,
										lineNumbers: !0,
									...
									}), CodeMirror.autoLoadMode(U.modal.code_mirror, n.code_mode), U.modal.resize_listener = L(window, "resize", u), l.style.display = "")
								}
							}))
						}
					})
				}
			}, U.modal.open = Math.random(), E("esc", F.close_modal, "keyup"), R(), w(!0), H(W.modal_bg, [0, .8]), H(i, [0, 1], [.98, 1], C)
		}, F.close_modal = function(t) {
			if (U.modal.open = !1, e.file && e.file.abort(), E("esc", "keyup"), U.modal.resize_listener && U.modal.resize_listener.remove(), H(W.modal_bg, [.8, 0]), H(i, [1, 0], [1, .98], (function() {
				W.modal.scrollTop = 0, w(), p(c), p(o), W.modal.classList.remove("modal-code-fullscreen"), i.classList.remove("modal-content-" + U.modal.type), U.modal.code_mirror = !1, "code" === U.modal.type && (l.style.display = "none")
		...
		function k(e, t) {
			M = !1, r.classList.remove("tooltip-loading"), D.timer(r, t, e ? "success" : "danger")
		}

		function V(e) {
			if (!M && !r.disabled) {
				if (_c.demo_mode) return ie.fire("Demo mode");
				if (!J) return ae.fire();
				if (!U.modal.item.is_writeable) return ie.fire("File is not writeable");
				M = !0, r.classList.add("tooltip-loading");
				var t = _c.current_dir;
				T({
					...
					complete: function(e) {
						k(e.success, e.error), e.success ? (te.fire(G.get("save", !0) + " " + U.modal.item.basename), I.remove(re(t.path, t.path.mtime)), delete t.files, delete t.html) : ie.fire(e.error)
					}
				})
			}
		}
		...
		function z() {
			W.modal.classList.toggle("modal-code-fullscreen"), u()
		}
	...
	var pe = function(e, t) {
		var i, a, n, o, l, s, r, c, p, d, m, f, v, g, _, h, x, b = this,
			y = !1,
			w = !0,
			C = {
				timeToIdle: 3e3,
				...
				32 === e.keyCode && (B.is_dual_input && b.toggleControls(!1), b.setIdle(!c))
			}, M = function(e, t, i) {
				e.classList[i ? "add" : "remove"]("pswp__" + t)
			}, k = function() {
				var e = 1 === g.getNumItemsFn();
				e !== v && (M(i, "ui--one-slide", e), v = e)
			}, V = 0,
			z = function() {
				...
				m !== e && (t.toggle_class(d, "svg-preloader-active", !e), m = e)
			}, E = [{
				name: "caption",
				option: "captionEl",
				onInit: function(e) {
		...
		b.init = function() {
			var n, o, l, c;
			t.copy_unique(e.options, C), g = e.options, i = U.popup.ui, (p = e.listen)("onVerticalDrag", (function(e) {
				...
				r.style.display = i ? "" : "none", r.setAttribute("href", i ? u(i) : "#")
				...
				t.bind(i, "pswpTap click", L), t.bind(U.popup.scrollwrap, "pswpTap", b.onGlobalTap), t.bind(document, "keydown", H)
			})), p("unbindEvents", (function() {
				h && clearInterval(h), t.unbind(document, "mouseout", j), t.unbind(document, "mousemove", z), t.unbind(i, "pswpTap click", L), t.unbind(U.popup.scrollwrap, "pswpTap", b.onGlobalTap), t.unbind(document, "keydown", H)
			})), p("destroy", (function() {
			...
			})(i.children), c(U.popup.topbar.children), k(), g.timeToIdle && p("mouseUsed", (function() {
				t.bind(document, "mousemove", z), t.bind(document, "mouseout", j), h = setInterval((function() {
					2 == ++V && b.setIdle(!0)
				}), g.timeToIdle / 2)
			})), g.preloaderEl && (A(!0), p("beforeChange", (function() {
			...
			if (!_)
				if (t.detail && "mouse" === t.detail.pointerType) {
					if (!t.detail.rightClick)
						...
						var a = (g.getNumItemsFn() > 2 || !e.getCurrentIndex()) && ("next" == g.click || t.detail.releasePoint.x > U.popup.pswp.clientWidth / 2) ? "next" : "prev";
						e[a]()
					}
				} else B.is_dual_input ? B.legacy_ie || b.setIdle(!c) : b.toggleControls(!w)
		}, b.toggleControls = function(e) {
			w = e, e && !y && b.update(), M(i, "ui--hidden", !e)
		}
	}, de = {
			...
			Object.assign(o, a);
			var l, s, r, c, p, d, m, u, f, v, g, _, h, x, b, y, w, C, L, H, M, k, V, z, j, A, E, I, T, O, S, Z, R, D, P, q, F, N, W, X, Y, G, K, J, Q, $, ee, te, ie, ae, ne, oe = {
					x: 0,
					y: 0
				}, le = {
					x: 0,
				...
				ge = function(e, t) {
					...
					J && !n.currItem.loadError && (e && (v > n.currItem.fitRatio ? ve || (Bt(n.currItem, !1, !0), ve = !0) : ve && (Bt(n.currItem), ve = !1)), Ce(J, se.x, se.y, v))
				}, He = function(e) {
				...
				Ie = function() {
					Ee && (de.unbind(document, "mousemove", Ie), Ae()), Ee = setTimeout((function() {
						Ee = null
					}), 100)
				}, Te = function(e, t) {
					...
					e && (F || q || Q || R) && (e.preventDefault(), e.stopPropagation())
				}, Pe = function() {
					n.setScrollOffset(0, de.getScrollY())
				}, qe = {}, Fe = 0,
				Ne = function(e) {
					...
					init: function() {
						if (!l && !s) {
							var i;
							for (n.framework = de, n.template = e, z = e.className, l = !0, E = de.features, k = E.raf, V = E.caf, p = U.popup.container.style, n.itemHolders = x = [{
								el: U.popup.items[0],
								wrap: 0,
								index: -1
							}, {
								...
								wrap: 0,
								index: -1
							}], x[0].el.style.display = x[2].el.style.display = "none", _ = "translate" + (M ? "(" : "3d("), f = {
								resize: n.updateSize,
								orientationchange: function() {
									clearTimeout(I), I = setTimeout((function() {
										re.x !== U.popup.scrollwrap.clientWidth && n.updateSize()
									}), 500)
								},
								scroll: Pe,
								keydown: Re,
							...
							if (t)(n.ui = new t(n, de)).init();
							be("firstUpdate"), c = c || o.index || 0, (isNaN(c) || c < 0 || c >= Zt()) && (c = 0), n.currItem = St(c), e.setAttribute("aria-hidden", "false"), void 0 === A && (be("initialLayout"), A = j = de.getScrollY());
							var a = "pswp--open" + (o.showHideOpacity ? " pswp--animate_opacity" : "") + (B.is_pointer && ("zoom" == o.click || o.getNumItemsFn() < 2) ? " pswp--zoom-cursor" : "");
							for (DOMTokenList.prototype.add.apply(e.classList, a.split(" ")), n.updateSize(), d = -1, ue = null, i = 0; i < 3; i++) Me((i + d) * me.x, x[i].el.style);
							de.bind(U.popup.scrollwrap, u, n), xe("initialZoomInEnd", (function() {
								n.setContent(x[0], c - 1), n.setContent(x[2], c + 1), x[0].el.style.display = x[2].el.style.display = "block", o.focus && e.focus(), de.bind(document, "keydown", n), de.bind(U.popup.scrollwrap, "click", n), E.is_mouse ? Ae() : B.is_pointer && de.bind(document, "mousemove", Ie), de.bind(window, "resize scroll orientationchange", n), be("bindEvents")
							})), n.setContent(x[1], c), n.updateCurrItem(), e.classList.add("pswp--visible")
						}
					},
					close: function() {
						l && (l = !1, s = !0, be("close"), setTimeout((function() {
							de.unbind(window, "resize scroll orientationchange", n)
						}), 400), de.unbind(window, "scroll", f.scroll), de.unbind(document, "keydown", n), B.is_pointer && de.unbind(document, "mousemove", Ie), de.unbind(U.popup.scrollwrap, "click", n), D && de.unbind(window, m, n), clearTimeout(I), be("unbindEvents"), Rt(n.currItem, null, !0, n.destroy))
					},
					destroy: function() {
						be("destroy"), Et && clearTimeout(Et), e.setAttribute("aria-hidden", "true"), e.className = z, de.unbind(U.popup.scrollwrap, u, n), de.unbind(window, "scroll", n), pt(), We(), he = {}
					},
					panTo: function(e, t, i) {
						i || (e > K.min.x ? e = K.min.x : e < K.max.x && (e = K.max.x), t > K.min.y ? t = K.min.y : t < K.max.y && (t = K.max.y)), e == se.x && t == se.y || (se.x = e, se.y = t, Le())
					},
					...
					goTo: function(e, t, i) {
						...
						if ("slide" === a) zt("swipe", 80 * e, {
							...
							var l = (e = _e(e)) - c;
							ue = l, c = e, n.currItem = St(c), ce -= l, ke(me.x * ce), We(), Q = !1, U.popup.image_anim && !U.popup.image_anim.paused && U.popup.image_anim.pause();
							var s = !! U.popup.transitions.hasOwnProperty(a) && U.popup.transitions[a](t);
							if (U.popup.caption_transition_delay = s && s.duration || 0, n.updateCurrItem(), !s) return;
					...
					updateCurrZoomItem: function(e) {
						...
						J = t.length && t[0].classList.contains("pswp__zoom-wrap") ? t[0].style : null, K = n.currItem.bounds, g = v = n.currItem.initialZoomLevel, se.x = K.center.x, se.y = K.center.y, e && be("afterChange")
					},
					...
					updateCurrItem: function(e) {
						if (0 !== ue) {
							var t, i = Math.abs(ue);
							if (!(e && i < 2)) {
								n.currItem = St(c), ve = !1, be("beforeChange", ue), i >= 3 && (d += ue + (ue > 0 ? -3 : 3), i = 3);
								for (var a = 0; a < i; a++) ue > 0 ? (t = x.shift(), x[2] = t, d++, Me((d + 2) * me.x, t.el.style), n.setContent(t, c - i + a + 1 + 1)) : (t = x.pop(), x.unshift(t), d--, Me(d * me.x, t.el.style), n.setContent(t, c + i - a - 1 - 1));
								if (J && 1 === Math.abs(ue)) {
									var o = St(b);
					...
					updateSize: function(e) {
						if (re.x = U.popup.scrollwrap.clientWidth, re.y = U.popup.scrollwrap.clientHeight, Pe(), me.x = re.x + Math.round(re.x * o.spacing), me.y = re.y, ke(me.x * ce), be("beforeResize"), void 0 !== d) {
							for (var t, i, a, l = 0; l < 3; l++) t = x[l], Me((l + d) * me.x, t.el.style), a = c + l - 1, o.loop && Zt() > 2 && (a = _e(a)), (i = St(a)) && (h || i.needsUpdate || !i.bounds) ? (n.cleanSlide(i), n.setContent(t, a), 1 === l && (n.currItem = i, n.updateCurrZoomItem(!0)), i.needsUpdate = !1) : -1 === t.index && a >= 0 && n.setContent(t, a), i && i.container && (Ft(i, re), Bt(i), He(i));
							h = !1
						}
						g = v = n.currItem.initialZoomLevel, (K = n.currItem.bounds) && (se.x = K.center.x, se.y = K.center.y, Le(!0)), be("resize")
					},
					zoomTo: function(e, t, i, a, n) {
						...
						je(l);
						var c = function(t) {
							1 === t ? (v = e, se.x = l.x, se.y = l.y) : (v = (e - s) * t + s, se.x = (l.x - r.x) * t + r.x, se.y = (l.y - r.y) * t + r.y), n && n(t), Le(1 === t)
						};
						i ? Be("customZoomTo", 0, 1, i, a || de.easing.sine.inOut, c) : c(1)
					}
				}, Ye = {}, Ge = {}, Ke = {}, Je = {}, Qe = {}, $e = [],
				et = {}, tt = [],
				it = {}, at = 0,
				...
				yt = function(e) {
					...
					var i, a, l, s, r = se[e] + t[e],
						...
						p = lt.x + t.x,
						d = lt.x - et.x;
					if (i = r > K.min[e] || r < K.max[e] ? o.panEndFriction : 1, r = se[e] + t[e] * i, (o.allowPanToNext || v === n.currItem.initialZoomLevel) && (J ? "h" !== $ || "x" !== e || q || (c ? (r > K.min[e] && (i = o.panEndFriction, K.min[e] - r, a = K.min[e] - le[e]), (a <= 0 || d < 0) && Zt() > 1 ? (s = p, d < 0 && p > et.x && (s = et.x)) : K.min.x !== K.max.x && (l = r)) : (r < K.max[e] && (i = o.panEndFriction, r - K.max[e], a = le[e] - K.max[e]), (a <= 0 || d > 0) && Zt() > 1 ? (s = p, d > 0 && p < et.x && (s = et.x)) : K.min.x !== K.max.x && (l = r))) : s = p, "x" === e)) return void 0 !== s && (ke(s, !0), W = s !== et.x), K.min.x !== K.max.x && (void 0 !== l ? se.x = l : W || (se.x += t.x * i)), void 0 !== s;
					...
					if ("pointerdown" !== e.type || !(e.which > 1 || e.ctrlKey))
						if (Ot) e.preventDefault();
							...
							if (ft(e, !0) && e.preventDefault(), be("pointerDown"), H) {
								var t = de.arraySearch($e, e.pointerId, "id");
								t < 0 && (t = $e.length), $e[t] = {
									x: e.pageX,
									y: e.pageY,
									id: e.pointerId
							...
							var i = yt(e),
								a = i.length;
							X = null, We(), D && 1 !== a || (D = ee = !0, de.bind(window, m, n), Z = ae = te = R = W = F = P = q = !1, $ = null, be("firstTouchStart", i), ze(le, se), oe.x = oe.y = 0, ze(Je, i[0]), ze(Qe, Je), et.x = me.x * ce, tt = [{
								x: Je.x,
								y: Je.y
							}], O = T = ye(), Te(v, !0), pt(), dt()), !Y && a > 1 && !Q && !W && (g = v, q = !1, Y = P = !0, oe.y = oe.x = 0, ze(le, se), ze(Ye, i[0]), ze(Ge, i[1]), gt(Ye, Ge, rt), st.x = Math.abs(rt.x) - se.x, st.y = Math.abs(rt.y) - se.y, G = ct(Ye, Ge))
						}
				}, Lt = function(e) {
					...
					if (X) {
						var e = X.length;
						if (0 !== e)
							if (ze(Ye, X[0]), Ke.x = Ye.x - Je.x, Ke.y = Ye.y - Je.y, Y && e > 1) {
								if (Je.x = Ye.x, Je.y = Ye.y, !Ke.x && !Ke.y && function(e, t) {
								...
								a < 0 && (a = 0), t, gt(Ye, Ge, nt), oe.x += nt.x - rt.x, oe.y += nt.y - rt.y, ze(rt, nt), se.x = Ve("x", i), se.y = Ve("y", i), Z = i > v, v = i, Le()
							} else {
								if (!$) return;
								if (ee && (ee = !1, Math.abs(Ke.x) >= 10 && (Ke.x -= X[0].x - Qe.x), Math.abs(Ke.y) >= 10 && (Ke.y -= X[0].y - Qe.y)), Je.x = Ye.x, Je.y = Ye.y, 0 === Ke.x && 0 === Ke.y) return;
								...
								}(ye(), Ye.x, Ye.y), F = !0, K = n.currItem.bounds, wt("x", Ke) || (wt("y", Ke), je(se), Le())
							}
					}
				}, Mt = function(e) {
					var t;
					if (be("pointerUp"), ft(e, !1) && e.preventDefault(), H) {
						var i = de.arraySearch($e, e.pointerId, "id");
						if (i > -1)
					...
					var r = -1;
					if (0 === s && (D = !1, de.unbind(window, m, n), pt(), Y ? r = 0 : -1 !== ot && (r = ye() - ot)), ot = 1 === s ? ye() : -1, a = -1 !== r && r < 150 ? "zoom" : "swipe", Y && s < 2 && (Y = !1, 1 === s && (a = "zoomPointerUp"), be("zoomGestureEnded")), X = null, F || q || Q || R)
						if (We(), S || (S = kt()), S.calculateSwipeSpeed("x"), R) {
							if (_t() < o.verticalDragRange) n.close();
							else {
								var c = se.y,
									p = ie;
								Be("verticalDrag", 0, 1, 300, de.easing.cubic.out, (function(e) {
									se.y = (n.currItem.initialPosition.y - c) * e + c, we((1 - p) * e + p), Le()
								})), be("onVerticalDrag", 1)
							}
						} else {
							if ((W || Q) && 0 === s) {
					...
					var e, t, i = {
							...
							calculateSwipeSpeed: function(a) {
								tt.length > 1 ? (e = ye() - O + 50, t = tt[tt.length - 2][a]) : (e = ye() - T, t = Qe[a]), i.lastFlickOffset[a] = Je[a] - t, i.lastFlickDist[a] = Math.abs(i.lastFlickOffset[a]), i.lastFlickDist[a] > 20 ? i.lastFlickSpeed[a] = i.lastFlickOffset[a] / e : i.lastFlickSpeed[a] = 0, Math.abs(i.lastFlickSpeed[a]) < .1 && (i.lastFlickSpeed[a] = 0), i.slowDownRatio[a] = .95, i.slowDownRatioReverse[a] = 1 - i.slowDownRatio[a], i.speedDecelerationRatio[a] = 1
							},
							calculateOverBoundsAnimOffset: function(e, t) {
								i.backAnimStarted[e] || (se[e] > K.min[e] ? i.backAnimDestination[e] = K.min[e] : se[e] < K.max[e] && (i.backAnimDestination[e] = K.max[e]), void 0 !== i.backAnimDestination[e] && (i.slowDownRatio[e] = .7, i.slowDownRatioReverse[e] = 1 - i.slowDownRatio[e], i.speedDecelerationRatioAbs[e] < .05 && (i.lastFlickSpeed[e] = 0, i.backAnimStarted[e] = !0, Be("bounceZoomPan" + e, se[e], i.backAnimDestination[e], t || 300, de.easing.sine.out, (function(t) {
									se[e] = t, Le()
								})))))
							},
							...
							panAnimLoop: function() {
								if (qe.zoomPan && (qe.zoomPan.raf = k(i.panAnimLoop), i.now = ye(), i.timeDiff = i.now - i.lastNow, i.lastNow = i.now, i.calculateAnimOffset("x"), i.calculateAnimOffset("y"), Le(), i.calculateOverBoundsAnimOffset("x"), i.calculateOverBoundsAnimOffset("y"), i.speedDecelerationRatioAbs.x < .05 && i.speedDecelerationRatioAbs.y < .05)) return se.x = Math.round(se.x), se.y = Math.round(se.y), Le(), void Ne("zoomPan")
							}
						};
					return i
				}, Vt = function(e) {
					...
					l && ((c += l) < 0 ? (c = o.loop ? Zt() - 1 : 0, s = !0) : c >= Zt() && (c = o.loop ? 0 : Zt() - 1, s = !0), s && !o.loop || (ue += l, ce -= l, a = !0));
					var p, d = me.x * ce,
						m = Math.abs(d - lt.x);
					return p = (a || d > lt.x == i.lastFlickSpeed.x > 0) && Math.abs(i.lastFlickSpeed.x) > 0 ? Math.max(Math.min(m / Math.abs(i.lastFlickSpeed.x), 400), 250) : 333, at === c && (a = !1), Q = !0, a && U.popup.toggle_timer(!1), Be("mainScroll", lt.x, d, p, de.easing.cubic.out, ke, (function() {
						We(), Q = !1, at = -1, (a || at !== c) && n.updateCurrItem(), be("mainScrollAnimComplete")
					...
					return te && !Z && !ae && v < t ? (n.close(), !0) : (te && (a = function(e) {
						we((1 - o) * e + o)
					}), n.zoomTo(e, 0, 200, de.easing.cubic.out, a), !0)
				};
			ge("Gestures", {
				publicMethods: {
					initGestures: function() {
						...
						(H = E.pointerEvent) && E.touch && (E.touch = !1), H ? e("pointer", "down", "move", "up", "cancel") : E.touch ? (e("touch", "start", "move", "end", "cancel"), M = !0) : e("mouse", "down", "move", "up"), m = w + " " + C + " " + L, u = y, H && !M && (M = B.is_touch), n.likelyTouchDevice = M, f[y] = Ct, f[w] = Lt, f[C] = Mt, L && (f[L] = f[C]), E.dual_input && (u += " mousedown", m += " mousemove mouseup", f.mousedown = f[y], f.mousemove = f[w], f.mouseup = f[C]), M || (o.allowPanToNext = !1)
					}
				}
			});
			var Et, It, Tt, Ot, St, Zt, Rt = function(t, i, a, l) {
					var s;
					Et && clearTimeout(Et), Ot = !0, Tt = !0, t.initialLayout ? (s = t.initialLayout, t.initialLayout = null) : s = o.getThumbBoundsFn && o.getThumbBoundsFn(c, a);
					var p = a ? o.hideAnimationDuration : o.showAnimationDuration,
						d = function() {
							Ne("initialZoom"), a ? (n.template.removeAttribute("style"), U.popup.bg.style.removeProperty("opacity")) : (we(1), i && (i.style.display = "block"), e.classList.add("pswp--animated-in")), be("initialZoom" + (a ? "OutEnd" : "InEnd")), l && l(), Ot = !1
						};
					if (!p || !s || void 0 === s.x) return be("initialZoom" + (a ? "Out" : "In")), a ? e.style.opacity = 0 : (v = t.initialZoomLevel, ze(se, t.initialPosition), Le(), e.style.opacity = 1, we(1)), void(p ? setTimeout((function() {
						d()
					}), p) : d());
					var m, u;
					m = r, u = !n.currItem.src || n.currItem.loadError || o.showHideOpacity, t.miniImg && (t.miniImg.style.webkitBackfaceVisibility = "hidden"), a || (v = s.w / t.w, se.x = s.x, se.y = s.y - j, U.popup[u ? "pswp" : "bg"].style.opacity = .001, Le()), Ue("initialZoom"), a && !m && e.classList.remove("pswp--animated-in"), u && (a ? de.toggle_class(e, "pswp--animate_opacity", !m) : setTimeout((function() {
						...
						if (be("initialZoom" + (a ? "Out" : "In")), a) {
							var i = s.w / t.w,
								...
								l = ie,
								r = function(t) {
									1 === t ? (v = i, se.x = s.x, se.y = s.y - A) : (v = (i - o) * t + o, se.x = (s.x - n.x) * t + n.x, se.y = (s.y - A - n.y) * t + n.y), Le(), u ? e.style.opacity = 1 - t : we(l - t * l)
								};
							m ? Be("initialZoom", 0, 1, p, de.easing.cubic.out, r, d) : (r(1), Et = setTimeout(d, p + 20))
						} else v = t.initialZoomLevel, ze(se, t.initialPosition), Le(), we(1), u ? e.style.opacity = 1 : we(1), Et = setTimeout(d, p + 20)
					}), a ? 10 : 20)
				}, Dt = {}, Pt = [],
				qt = {
					index: 0,
					...
					var t = e.img = de.createEl("pswp__img", "img"),
						i = function() {
					...
					if (e.src && e.loadError && e.container) return t && de.resetEl(e.container), e.container.innerHTML = o.errorMsg.replace("%url%", e.src), !0
				}, Bt = function(e, t, i) {
					if (e.src) {
			...
			ge("Controller", {
				publicMethods: {
					...
					initController: function() {
						de.copy_unique(o, qt), n.items = It = i, St = n.getItemAt, Zt = o.getNumItemsFn, o.loop, Zt() < 3 && (o.loop = !1), xe("beforeChange", (function(e) {
							var t, i = o.preload,
								a = null === e || e >= 0,
								l = Math.min(i[0], Zt()),
								s = Math.min(i[1], Zt());
					...
					setContent: function(e, t) {
						...
						if (s) {
							...
							var r = s.container = de.createEl("pswp__zoom-wrap");
							if (!s.src && s.html && (s.html.tagName ? r.appendChild(s.html) : r.innerHTML = s.html), Wt(s), Ft(s, re), !s.src || s.loadError || s.loaded) s.src && !s.loadError && ((a = de.createEl("pswp__img", "img")).style.opacity = 1, a.src = s.src, Bt(s, a), Nt(0, s, r, a));
							else {
								s.loadComplete = function(i) {
									if (l) {
										if (e && e.index === t) {
											if (Wt(i, !0)) return i.loadComplete = i.img = null, Ft(i, re), He(i), void(e.index === c && n.updateCurrZoomItem());
											i.imageAppended ? !Ot && i.placeholder && (i.placeholder.style.display = "none", i.placeholder = null) : Q || Ot ? Pt.push({
												item: i,
												baseDiv: r,
												img: i.img,
												index: t,
								...
								var p = s.msrc && (s.msrc !== s.src || !Tt),
									d = de.createEl("pswp__img pswp__img--placeholder" + (p ? "" : " pswp__img--placeholder--blank"), p ? "img" : "");
							...
							Tt || t !== c ? He(s) : (J = r.style, Rt(s, a || s.img)), de.resetEl(e.el), e.el.appendChild(r)
						} else de.resetEl(e.el)
					},
				...
				publicMethods: {
					...
					onTapRelease: function(e, t) {
						...
						if (t && (!F && !P && !Fe && (!H || U.popup.container.contains(e.target)))) {
							...
							if ("BUTTON" === e.target.tagName || e.target.classList.contains("pswp__single-tap")) return void Jt(e, t);
				...
				publicMethods: {
					...
					setupDesktopZoom: function(t) {
						...
						xe("bindEvents", (function() {
							de.bind(e, i, n.handleMouseWheel)
						})), xe("unbindEvents", (function() {
							Gt && de.unbind(e, i, n.handleMouseWheel)
						})), n.mouseZoomedIn = !1;
						var a, o = function() {
								n.mouseZoomedIn && (e.classList.remove("pswp--zoomed-in"), n.mouseZoomedIn = !1), de.toggle_class(e, "pswp--zoom-allowed", v < 1), l()
							}, l = function() {
					...
					handleMouseWheel: function(e) {
						if (v <= n.currItem.fitRatio) return !o.closeOnScroll || Fe || D ? e.preventDefault() : Math.abs(e.deltaY) > 2 && (r = !0, n.close()), !0;
					...
					toggleDesktopZoom: function(t) {
						...
						var i = o.getDoubleTapZoom(!0, n.currItem),
							a = v === i;
						n.mouseZoomedIn = !a, n.zoomTo(a ? n.currItem.initialZoomLevel : i, t, 333), de.toggle_class(e, "pswp--zoomed-in", !a)
					}
				}
			});
					...
					initHistory: function() {
						if (de.copy_unique(o, ri), o.history) {
							...
							t > -1 && "&" === (ai = ai.substring(0, t)).slice(-1) && (ai = ai.slice(0, -1)), setTimeout((function() {
								l && de.bind(window, "hashchange", n.onHashChange)
							}), 40)
						}
					},
	...
	function ue() {
		...
		})), _query(".preloader-body").remove(), document.body.classList.remove("body-loading"), !_c.prevent_right_click && _c.context_menu && (W.files_container && W.files_container.addEventListener("contextmenu", (function(e) {
			var t = e.target.closest(".files-a");
			F.create_contextmenu(e, "files", t || W.files_container, t ? _c.files[t.dataset.name] : _c.current_dir)
		...
		if (_c.menu_exists) {
			W.sidebar = _id("sidebar"), W.sidebar_inner = _id("sidebar-inner"), W.sidebar_menu = _id("sidebar-menu"), W.sidebar_toggle = _id("sidebar-toggle"), W.sidebar_modal = _id("sidebar-bg"), W.sidebar_topbar = _id("sidebar-topbar");
			var e, t, n, o, l, s = !1,
				c = !1,
				p = {}, d = !1,
			...
			}, W.sidebar_toggle.innerHTML = F.get_svg_icon_multi("menu", "menu_back"), w(W.sidebar_toggle, x, "click"), w(W.sidebar_modal, x, "click"), F.create_menu = V;
			...
			!(!f || v && ! function() {
				...
				return !0
			}()) ? V(f, "menu from localstorage [" + (_c.menu_cache_validate ? "shallow menu" : "menu cache validation disabled") + "]") : (W.sidebar_menu.classList.add("sidebar-spinner"), W.sidebar_menu.dataset.title = G.get("loading"), T({
				...
				complete: function(e, t, i) {
					if (W.sidebar_menu.classList.remove("sidebar-spinner"), delete W.sidebar_menu.dataset.title, !i || !e || e.error || !Object.keys(e).length) return Q(), void j("Error or no dirs!");
					e.localstorage ? V(f, "menu from localstorage") : (V(e, "menu from " + (_c.menu_cache_file ? "JSON cache: " + _c.menu_cache_file : "xmlhttp")), B.local_storage && setTimeout((function() {
						F.clean_localstorage(), I.set("files:menu:" + _c.menu_cache_hash, t)
					}), 1e3))
				}
			}))
		}
		...
		function _(t, i) {
			...
			var o = Object.keys(p).length,
				l = o === n.length;
			d !== l && (d = l, B.is_pointer && (e.title = G.get(d ? "collapse menu" : "expand menu")), e.classList.toggle("is-expanded", d)), B.local_storage && (s && clearTimeout(s), s = setTimeout((function() {
		...
		function x(e) {
			F.set_config("menu_show", !_c.menu_show), document.documentElement.classList.toggle("sidebar-closed"), u = !u
		}
		...
		function V(i, a) {
			...
			if (Q(), j(a, i), k(i, (e = > {
				...
				k(e, (function(e, o) {
					...
					if (l) {
						var s = (l.match(/\//g) || []).length + 1,
							r = s - i;
						i = s, a += r, n && (t += L(n, r > 0)), t += r > 0 ? '<ul style="--depth:' + (a - 1) + '" class="menu-' + (n ? "ul" : "root") + '">' : "</li>" + b("</ul></li>", -r), n = _c.dirs[l]
					}
				})), t += L(n, !1) + b("</li></ul>", a), W.sidebar_menu.innerHTML = t
			}(i), t = W.sidebar_menu.firstChild, n = _class("has-ul", t), o = n.length ? M(Array.from(t.children), "has-ul", !0) : [], s = o, l = n.filter((function(e) {
				return !s.includes(e)
			})), k(_class("menu-li", t), (function(e) {
				var t = _c.dirs[e.dataset.path];
				t && (t.menu_li = e)
			})), F.set_menu_active(_c.current_path || _c.init_path), B.local_storage && (W.sidebar_menu.scrollTop = I.get("files:interface:menu_scroll:" + _c.location_hash) || 0, w(W.sidebar_menu, C((function() {
				I.set("files:interface:menu_scroll:" + _c.location_hash, W.sidebar_menu.scrollTop, !0)
			}), 1e3), "scroll")), n.length && (r = !1, d = Object.keys(p).length === n.length, W.sidebar_topbar.innerHTML = '<button id="menu-toggle" type="button" class="btn-icon' + (d ? " is-expanded" : "") + '">' + F.get_svg_icon_multi("plus", "minus") + "</button>", w(e = W.sidebar_topbar.lastElementChild, (function(e) {
				if (d) {
					var t = [],
						i = [],
						a = !1,
					...
					k(o, (function(e) {
						if (e.classList.contains("menu-li-open"))
							if (a) t.push(e);
								...
								n.top > s || n.bottom - n.top > 2 * s ? (t.push(e), a = !0) : i.push(e)
							}
				...
				} else n.length > 100 ? H(n, "menu-li-open", !0) : (t = [], i = [], a = !1, s = window.innerHeight, k(n, (function(e) {
					e.classList.contains("menu-li-open") || (a || !e.offsetParent ? t.push(e) : e.getBoundingClientRect().top > s || e.lastChild.childNodes.length > 50 ? (a = !0, t.push(e)) : i.push(e))
				})), t.length && k(t, (function(e) {
				...
				m.delay = anime.stagger(Z(20, 50, Math.round(200 / m.targets.length))), anime(m)
			}
			w(t, (function(e) {
				...
				if (e.target !== t) {
					...
					if (!y(e, r))
						if (l && r !== c) F.get_files(s.dataset.path, "push"), matchMedia("(min-width: 992px)").matches ? _c.menu_show || (i = W.sidebar, a = "sidebar-clicked", n = null, o = 1e3, i.classList.add(a), n && (i.disabled = n), setTimeout((function() {
	...
	function() {
		...
		U.sort.keys.includes(t[0]) || (t[0] = "name"), t[1] && ["asc", "desc"].includes(t[1]) || (t[1] = U.sort.sorting[t[0]].order), t.join("_") !== _c.sort && (_c.sort = t.join("_")), e(t[0], t[1]);
		var i = _id("change-sort");
		i.innerHTML = '<button type="button" class="btn-icon btn-topbar">' + F.get_svg_icon("sort_" + U.sort.sort + "_" + U.sort.order) + '</button><div class="dropdown-menu dropdown-menu-topbar dropdown-menu-center"><h6 class="dropdown-header" data-lang="sort">' + G.get("sort") + "</h6>" + V(U.sort.keys, (function(e) {
			return '<button class="dropdown-item' + (e === U.sort.sort ? " active sort-" + U.sort.order : "") + '" data-action="' + e + '">' + F.get_svg_icon_multi("menu_down", "menu_up") + F.get_svg_icon_multi("sort_" + e + "_asc", "sort_" + e + "_desc") + '<span class="dropdown-text" data-lang="' + e + '">' + G.get(e) + "</span></button>"
		})) + "</div>";
		var a = i.firstChild,
		...
		function l(e, t) {
			if (_c.sort_dirs_first && e._values.is_dir !== t._values.is_dir) return (t._values.is_dir ? 1 : -1) * U.sort.multi;
		...
		function p(e, t, i) {
			var a = i ? "add" : "remove";
			e && (o[U.sort.index].classList[a]("active"), d[U.sort.index].classList[a]("sortbar-active")), (e || t) && (o[U.sort.index].classList[a]("sort-" + U.sort.order), d[U.sort.index].classList[a]("sort-" + U.sort.order))
		}
		F.set_sort = function(t) {
			if (t) {
				var i = t !== U.sort.sort,
					...
					o = n !== U.sort.order;
				p(i, o, !1), e(t, n), a.innerHTML = F.get_svg_icon("sort_" + t + "_" + n), p(i, o, !0), F.set_config("sort", U.sort.sort + "_" + U.sort.order)
			}
		...
		})), m(n, F.set_sort), W.sortbar = _id("files-sortbar"), W.sortbar.className = "sortbar-" + _c.layout, W.sortbar.innerHTML = '<div class="sortbar-inner">' + V(U.sort.keys, (function(e) {
			return '<div class="sortbar-item sortbar-' + e + (e === U.sort.sort ? " sortbar-active sort-" + U.sort.order : "") + '" data-action="' + e + '"><span data-lang="' + e + '" class="sortbar-item-text">' + G.get(e) + "</span>" + F.get_svg_icon_multi("menu_down", "menu_up") + "</div>"
		})) + "</div>";
	...
	function() {
		if (W.topbar_top = _id("topbar-top"), U.topbar = {
			info: {}
		}, W.filter.placeholder = G.get("filter"), W.filter.title = B.c_key + "F", se.hash(), W.filter.parentElement.insertAdjacentHTML("beforeend", F.get_svg_icon("search")), G.dropdown(), _c.has_login) {
			W.topbar_top.insertAdjacentHTML("beforeend", '<a href="' + location.href.split("?")[0] + '?logout" class="btn-icon btn-topbar" id="logout"' + x("logout", !0) + ">" + F.get_svg_icon("logout") + "</a>");
			var e = W.topbar_top.lastElementChild;
			w(e, (function(t) {
				t.preventDefault(), ne.fire(G.get("logout", !0) + "?").then((t = > {
					t.isConfirmed && location.assign(e.href)
				}))
			}))
		}
		screenfull.isEnabled && (W.topbar_top.insertAdjacentHTML("beforeend", '<button class="btn-icon btn-topbar" id="topbar-fullscreen">' + F.get_svg_icon_multi("expand", "collapse") + "</button>"), w(W.topbar_top.lastElementChild, (function() {
			screenfull.toggle()
			...
			W.topbar_info.classList.contains("info-search") ? (W.topbar_info.classList.toggle("info-nomatch", !t), W.topbar_info.children[0].textContent = t, W.topbar_info.children[2].textContent = e) : F.topbar_info('<span class="info-search-count">' + t + '</span><span class="info-search-lang"><span data-lang="matches found for">' + G.get("matches found for") + '</span></span><span class="info-search-phrase">' + e + '</span><button class="info-search-reset" data-action="reset">' + F.get_svg_icon("close") + "</button>", "search" + (t ? "" : " info-nomatch"))
		}
	}(), _c.config.favicon && document.head.insertAdjacentHTML("beforeend", _c.config.favicon), "IntersectionObserver" in window && "IntersectionObserverEntry" in window && "intersectionRatio" in window.IntersectionObserverEntry.prototype ? ue() : F.load_plugin("intersection-observer", ue, {
